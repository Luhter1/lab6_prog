...
public class validation{
     ...
     */
    public static long ID(String Sid) throws PositiveException, StringParseException, NullValueException{
    
        long id;
        if(Sid.equals("null")) throw new NullValueException("id");

        try{
            id = Long.parseLong(Sid);
        }catch(Exception e){throw new StringParseException("long", Sid);}

        if(id<=0) throw new PositiveException("id");
